...
function Navbar({ size }) {
	...
	return (
		<nav className="w-full sticky top-0 bg-black text-white text-lg font-normal z-10 flex items-center justify-between py-3 px-8 md:flex-row md:py-1 lg:flex-row lg:py-0">
			...
			<div
				onClick={handleClick}
				className="absolute right-4 top-7 cursor-pointer lg:hidden hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
			>
				{!open ? (
